---
applyTo: "src/Ncp.Mom.Domain/DomainEvents/*.cs"
---
...
- 类文件应放置在 `src/Ncp.Mom.Domain/DomainEvents` 目录下。
- 为每个聚合添加一个领域事件文件。
...
**文件**: `src/Ncp.Mom.Domain/DomainEvents/UserDomainEvents.cs`

```csharp
using Ncp.Mom.Domain.Aggregates.UserAggregate;
