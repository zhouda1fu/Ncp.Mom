---
applyTo: "src/Ncp.Mom.Web/Application/Commands/**/*.cs"
---
...
- 类文件应放置在 `src/Ncp.Mom.Web/Application/Commands/{Module}s/` 目录下（以模块复数形式命名，避免命名空间与聚合类名冲突）。
...
**文件**: `src/Ncp.Mom.Web/Application/Commands/Users/CreateUserCommand.cs`

```csharp
using Ncp.Mom.Domain.AggregatesModel.UserAggregate;
using Ncp.Mom.Infrastructure.Repositories;

namespace Ncp.Mom.Web.Application.Commands.Users;
