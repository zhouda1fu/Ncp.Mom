---
applyTo: "src/Ncp.Mom.Web/Application/DomainEventHandlers/*.cs"
---
...
- 类文件应放置在 `src/Ncp.Mom.Web/Application/DomainEventHandlers/` 目录下。
...
using Ncp.Mom.Web.Domain.DomainEvents;
