---
applyTo: "src/Ncp.Mom.Web/Application/IntegrationEvents/*.cs"
---
...
- 类文件应放置在 `src/Ncp.Mom.Web/Application/IntegrationEvents/` 目录下。
- 文件名格式为 `{Entity}{Action}IntegrationEvent.cs`。
- 每个集成事件一个文件。

## 代码示例

**文件**: `src/Ncp.Mom.Web/Application/IntegrationEvents/UserCreatedIntegrationEvent.cs`
