...
- 领域层测试：`test/Ncp.Mom.Domain.Tests/{EntityName}Tests.cs`。
- Web 层测试：`test/Ncp.Mom.Web.Tests/{Feature}Tests.cs`。
- 基础设施层测试：`test/Ncp.Mom.Infrastructure.Tests/{Component}Tests.cs`。
