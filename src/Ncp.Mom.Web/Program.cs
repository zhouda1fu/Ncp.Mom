...
using Ncp.Mom.Web.Application.IntegrationEventHandlers;
...
try
{
    ...
    app.MapHub<Ncp.Mom.Web.Application.Hubs.ChatHub>("/chat");
    ...
    app.MapGet("/code-analysis", () =>
    {
        var html = VisualizationHtmlBuilder.GenerateVisualizationHtml(
            CodeFlowAnalysisHelper.GetResultFromAssemblies(typeof(Program).Assembly,
                ...
                typeof(Ncp.Mom.Domain.AggregatesModel.OrderAggregate.Order).Assembly)
        );
