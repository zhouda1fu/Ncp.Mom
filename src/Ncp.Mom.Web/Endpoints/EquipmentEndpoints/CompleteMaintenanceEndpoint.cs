...
public record CompleteMaintenanceRequest(EquipmentId Id);
...
/// </summary>
[Tags("Equipments")]
public class CompleteMaintenanceEndpoint(IMediator mediator) : Endpoint<CompleteMaintenanceRequest, ResponseData<bool>>
{
    /// <summary>
    /// 配置端点的基本设置
    /// 包括HTTP方法、认证方案、权限要求等
